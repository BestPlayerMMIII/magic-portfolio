<template>
  <div class="projects-list grid gap-4 sm:grid-cols-1 md:grid-cols-2">
    <div
      v-for="project in items"
      :key="project.id"
      class="project-card rounded-lg p-4 sm:p-6 border transition-all duration-300 cursor-pointer hover:scale-105"
      :class="{
